...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col lg:flex-row justify-center items-center overflow-hidden pt-20 bg-gradient-to-br from-indigo-50 via-white to-indigo-100 dark:from-[#050816] dark:via-[#0d1433] dark:to-[#050816]"
    >
      ...
      <div className="relative z-10 max-w-2xl px-6 flex flex-col items-start py-12">
        ...
        >
          ...
          My focus is on performance, clean architecture, and impactful digital
          products.
        </motion.p>
        ...
        >
          <Link
            ...
            smooth
            duration={700}
            className="flex items-center gap-2 px-8 py-3 rounded-3xl text-sm font-bold text-[#4A90E2] border-2 border-[#4A90E2]  hover:text-white hover:scale-105 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 cursor-pointer select-none"
          >
          ...
          <Link
            ...
            smooth
            duration={700}
            className="flex items-center gap-2 px-8 py-3 rounded-3xl text-sm font-bold text-white bg-[#4A90E2] hover:bg-[#3A78B8] hover:scale-105 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 cursor-pointer select-none"
          >
